...
while True:
    ...
    if (x<=100 and x>=-100 and z<=100 and z>=-100 and y<=300 and y>=200): # left
        #move.play()
    ...
    elif (x<=100 and x>=-100 and z<=100 and z>=-100 and y>=-300 and y<=-200): # Right
        thankyou.play()
        time.sleep(2)

    elif (y<=100 and y>=-100 and z<=100 and z>=-100 and x>=200 and x<=300): # hello
        hello.play()
        time.sleep(2)

    elif (x<=100 and x>=-100 and y<=100 and y>=-100 and z>=200 and z<=300): # Give
        #give.play()
    ...
    elif (y<=100 and y>=-100 and z<=100 and z>=-150 and x>=-300 and x<=-200): # Come
        bye.play()
        time.sleep(2)
